...
class SolMaterialChoises(models.Model):
    ...
    material = models.ForeignKey(Recurso, on_delete=models.CASCADE, verbose_name="Material", related_name="material")
    mat_name = property(lambda self: self.material.nombre)
